...
function renderMissingGame() {
  return '<section class="view"><a class="back-link" href="#/library">← Volver a mi biblioteca</a><div class="library-empty"><span aria-hidden="true">🎮</span><h2>Juego no encontrado</h2><p>Este videojuego no está en tu biblioteca o pudo haber sido eliminado.</p><a href="#/library">Ir a mi biblioteca</a></div></section>'
}
